...
round(sum(CASE WHEN is_promo_period THEN net_sales_eur ELSE 0 END),
2) AS promo_period_sales_eur,
round(sum(CASE WHEN is_self_checkout THEN net_sales_eur ELSE 0 END),
2) AS self_checkout_sales_eur,
...
round(try_divide(sales_basket_count,
total_basket_count) * 100,
4) AS basket_penetration_pct,
round(try_divide(units_sold,
sales_basket_count),
2) AS average_units_per_product_basket,
round(try_divide(promo_period_sales_eur,
net_sales_eur) * 100,
2) AS promo_sales_share_pct,
round(try_divide(member_sales_eur,
net_sales_eur) * 100,
2) AS member_sales_share_pct,
